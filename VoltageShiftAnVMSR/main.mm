...
void usage(const char *name)
{
    ...
    printf("show if AC power pluged in: ischarging\n\n");
}
...
int main(int argc, const char *argv[])
{
    ...
    else if (!strncmp(parameter, "ischarging", 10))
    {

        // get system power source information
        CFTypeRef powerInfo = IOPSCopyPowerSourcesInfo();

        // get power type string reference
        CFStringRef str = IOPSGetProvidingPowerSourceType(powerInfo);
